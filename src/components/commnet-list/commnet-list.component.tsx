...
export function CommentList(props: ICommnetList.Props) {
  ...
  return (
    <>
      <div className="w-full flex flex-wrap box-border relative gap-2" data-title="rp-list-container">
        <ContainerComp>
          <ul data-title="rp-list" className="w-full flex flex-wrap box-border relative gap-2 other/rp-list">
            <RepComp>
              <li
                ...
                className={cn("w-full flex flex-wrap gap-2 relative box-border scroll-margin-[60px]")}
              >
                <div
                  className={cn(
                  ...
                  <div className="w-full flex flex-wrap flex-grow flex-shrink relative min-w-0 gap-0.5">
                    ...
                    <div className="w-full flex flex-wrap gap-2 relative mt-1">
                      <ul className="w-full flex flex-wrap gap-2 relative">
                        <li
                          className={cn(
                            "px-2 py-1 cursor-pointer text-xs text-light-color-3/70 rounded-md",
                            "inline-flex tt-body-guestbook:hidden",
                ...
                <ReplyContainerComp>
                  <ul data-title="sub-rp-list" className="w-full flex flex-wrap box-border relative gap-2">
                    <ReplyRepComp>
                      <li
                        id={`[##_${prefix}_rep_id_##]`}
                        data-title="sub-rp-item"
                        className="w-full flex flex-wrap relative scroll-margin-[60px]"
                      >

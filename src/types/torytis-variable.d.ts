...
declare namespace JSX {
  interface IntrinsicElements {
		...
		's_if_var_post_permalink_text_line_height': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
		's_not_var_post_permalink_text_line_height': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
		's_if_var_post_permalink_codeblock_text_line_height': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
		's_not_var_post_permalink_codeblock_text_line_height': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
	}
}
